...
namespace Batalha_Naval.model
{
    public class IA
    {
        ...
        direcaoCorreta lastDir = direcaoCorreta.x_Plus;
        ...
        private (int, int) escolherEixo(Tabuleiro tabPlayer)
        {
            ...
            while (true)
            {
                ...
                if (posicoesFinaisBarcoAtigindoEixoX.Count > 0)
                {
                    ...
                    if (lastDir.Equals(direcaoCorreta.x_Plus))
                    {
                        ...
                        {
                            lastDir = direcaoCorreta.x_Minus;
                        }
                    }
                    if (lastDir.Equals(direcaoCorreta.x_Minus))
                    {
                        ...
                        {
                            lastDir = direcaoCorreta.y_Plus;
                        }
                    }
                    if (lastDir.Equals(direcaoCorreta.y_Plus))
                    {
                        ...
                        {
                            lastDir = direcaoCorreta.y_Minus;
                        }
                    }
                    if (lastDir.Equals(direcaoCorreta.y_Minus))
                    {
                    ...
                    if (lastDir.Equals(direcaoCorreta.nada))
                    {
